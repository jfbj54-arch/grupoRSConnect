...
// PARTE 1 DE 4
// BASE + BANCO + LOGIN + CADASTRO + SERVIÇOS + ACEITAR VAGA
// ============================================================
...
async function criarTabelas() {
    try {
        ...
        console.log(
            '✅ Tabelas e colunas principais verificadas.'
        );
...
// Compatibilidade com todas as versões do INDEX
app.post(
    '/api/auth/cadastro',
    cadastrarUsuarioRS
);
...
// Compatibilidade com INDEX antigo e novo
app.post(
    '/api/auth/login',
    loginUsuarioRS
);
